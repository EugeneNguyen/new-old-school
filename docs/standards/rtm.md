...
| REQ-00117 | Activity: show prompt sent to agent | Feature request (user) | `docs/standards/system-architecture.md`, `docs/standards/glossary.md` (ActivityEntry, Adapter) | `lib/activity-log.ts`, `lib/stage-pipeline.ts`, `app/dashboard/activity/page.tsx` | Manual validation — all 11 ACs pass (see REQ-00117 Validation section) | Done |
