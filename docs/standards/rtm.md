...
| REQ-00116 | User comment triggers pipeline restart | Feature request (user) | `docs/standards/system-architecture.md`, `docs/standards/api-reference.md` | `app/api/workflows/[id]/items/[itemId]/comments/route.ts`, `lib/activity-log.ts` | Manual validation — all 8 ACs pass (see REQ-00116 Validation section) | Done |
| REQ-00117 | Activity: show prompt sent to agent | Feature request (user) | `docs/standards/system-architecture.md`, `docs/standards/glossary.md` (ActivityEntry, Adapter) | `lib/activity-log.ts`, `lib/stage-pipeline.ts`, `app/dashboard/activity/page.tsx` | Manual validation u2014 all 9 ACs pass (see REQ-00117 Validation section) | Done |
| REQ-00118 | Item detail > comment should have send button when commenting | Feature request (user) | `docs/standards/ui-design.md`, `docs/standards/ux-design.md` | `components/dashboard/ItemDetailDialog.tsx` | Manual validation u2014 all 9 ACs pass (see REQ-00118 Validation section) | Done |
